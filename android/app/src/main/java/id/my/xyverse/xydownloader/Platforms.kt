...
object PlatformCatalog {
    ...
    val all = listOf(
        ...
        Platform("threads", "Threads", "us", listOf("threads.net", "threads.com"), R.drawable.logo_threads, "Plugin DownloadAja"),
        ...
        Platform("kuaishou", "Kuaishou 快手", "cn", listOf("kuaishou.com", "chenzhongtech.com", "gifshow.com"), R.drawable.logo_kuaishou, "Plugin DownloadAja"),
